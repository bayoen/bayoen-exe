...
{
    class OutlineTextControl : FrameworkElement
    {
        ...
        /// <summary>
        /// Specifies whether the font should display ExtraBold font weight.
        /// </summary>
        public bool ExtraBold
        {
            get
            {
                return (bool)GetValue(ExtraBoldProperty);
            }

            set
            {
                SetValue(ExtraBoldProperty, value);
            }
        }
        ...
        /// Identifies the Bold dependency property.
        /// </summary>
        public static readonly DependencyProperty ExtraBoldProperty = DependencyProperty.Register(
            "ExtraBold",
            typeof(bool),
            typeof(OutlineTextControl),
            new FrameworkPropertyMetadata(
